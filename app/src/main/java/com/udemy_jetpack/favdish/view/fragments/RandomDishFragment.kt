...
import com.udemy_jetpack.favdish.model.network.network_connection.NetworkConnection
...
class RandomDishFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        randomDishNetworkConnectivityChecker()
    ...
    private fun randomDishNetworkConnectivityChecker() {
        val networkConnectivity = NetworkConnection(requireContext())
